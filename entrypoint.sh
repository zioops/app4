...
UUID=${UUID:-'1aab1be5-0ae4-48b9-8982-d9fdf7037594'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess-top'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless-top'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trojan-top'}
SS_WSPATH=${SS_WSPATH:-'/shadowsocks-top'}
